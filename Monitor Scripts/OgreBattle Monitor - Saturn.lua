...
function stats()
  -- Cards
  c1 = hextotarot(memory.readbyte(0xCD46D))
  c2 = hextotarot(memory.readbyte(0xCD46C))
  c3 = hextotarot(memory.readbyte(0xCD46F))
  c4 = hextotarot(memory.readbyte(0xCD46E))
  c5 = hextotarot(memory.readbyte(0xCD471))
  c6 = hextotarot(memory.readbyte(0xCD470))
  c7 = hextotarot(memory.readbyte(0xCD473))
  -- Cards raw hex
  c1hex = memory.readbyte(0xCD46D)
  c2hex = memory.readbyte(0xCD46C)
  c3hex = memory.readbyte(0xCD46F)
  c4hex = memory.readbyte(0xCD46E)
  c5hex = memory.readbyte(0xCD471)
  c6hex = memory.readbyte(0xCD470)
  c7hex = memory.readbyte(0xCD473)
  -- Main Timer count
  t1 = memory.readbyte(0xF9670)
  -- Secondary timer count
  t2 = memory.readbyte(0xF9671)
  -- Leader Name
  leadername = hextotext(memory.readbyte(0xF9675)) .. hextotext(memory.readbyte(0xF9674)) .. hextotext(memory.readbyte(0xF9677)) .. hextotext(memory.readbyte(0xF9676)) .. hextotext(memory.readbyte(0xF9679)) .. hextotext(memory.readbyte(0xF9678)) .. hextotext(memory.readbyte(0xF967B)) .. hextotext(memory.readbyte(0xF967A))
